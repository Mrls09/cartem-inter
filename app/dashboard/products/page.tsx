...
import { Button, Input, Chip, Modal, ModalContent, ModalHeader, ModalBody, ModalFooter, Dropdown, DropdownTrigger, DropdownMenu, DropdownItem, Tooltip } from "@nextui-org/react"
...
export default function ProductsPage() {
  ...
  const [token, setToken] = useState("");  // Acceder al token desde el AuthContext
  ...
  useEffect(() => {
    const storageToke = Cookies.get("token");
